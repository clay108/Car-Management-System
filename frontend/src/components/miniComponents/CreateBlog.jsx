  ...
  const handleBlog = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        `${import.meta.env.VITE_BACKEND_URI}/api/v1/blog/post`,
        formData,
        {
      ...
      <div className="container">
        <form onSubmit={handleBlog}>
          ...
          <div className="sub-para">
            ...
            <textarea
              rows="10"
              placeholder="Post First Sub Paragraph Comes Here..."
          ...
          <div className="sub-para">
            ...
            <textarea
              rows="10"
              placeholder="Post Second Sub Paragraph Comes Here..."
          ...
          <div className="sub-para">
            ...
            <textarea
              rows="10"
              placeholder="Post Third Sub Paragraph Comes Here..."
